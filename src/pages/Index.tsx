  ...
  const plans = [
    {
      name: "Free Plan",
      price: "Free",
      tagline: "Build your inventory quickly at no cost",
      features: [
        "Basic profile",
        "One photo",
        "One demo video",
    ...
    {
      name: "BM Professional",
      price: "$79",
      tagline: "For growing booking operations",
      features: [
        "Up to 100 performers",
    ...
    },
    {
      name: "BM Agency",
      price: "$199",
      tagline: "For full-service agencies",
      features: [
        "Unlimited performers",
        "Multiple booking managers",
        "Stripe integration",
        "Advanced reporting",
