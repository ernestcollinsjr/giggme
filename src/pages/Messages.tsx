        ...
        <div className={cn(
          ...
          {activeConversation ? (
            <>
              ...
              {/* Bottom input area container - mb-16 creates space above the fixed bottom nav */}
              <div className="flex-shrink-0 border-t border-border bg-background p-4 mb-16 md:mb-0">
                {/* Typing indicator */}
                {typingUsers.size > 0 && (
